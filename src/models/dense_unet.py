...
class TernausNetV2(nn.Module):
    ...
    def __init__(self, densenet_model, num_classes=1, num_filters=32, is_deconv=False, **kwargs):
        """
        Args:
        ...
        self.conv1 = nn.Sequential(OrderedDict([
            ('conv0', densenet_model.features.conv0),
            ('norm0', densenet_model.features.norm0),
            ('pool0', densenet_model.features.pool0),
        ]))
        self.conv2 = nn.Sequential(OrderedDict([
            ('denseblock1', densenet_model.features.denseblock1),
            ('transition1', densenet_model.features.transition1),
        ]))
        self.conv3 = nn.Sequential(OrderedDict([
            ('denseblock2', densenet_model.features.denseblock2),
            ('transition2', densenet_model.features.transition2),
        ]))
        self.conv4 = nn.Sequential(OrderedDict([
            ('denseblock3', densenet_model.features.denseblock3),
            ('transition3', densenet_model.features.transition3),
        ]))
        self.conv5 = nn.Sequential(OrderedDict([
            ('denseblock4', densenet_model.features.denseblock4),
        ]))
